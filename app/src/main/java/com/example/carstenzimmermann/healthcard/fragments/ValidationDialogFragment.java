...
/**
 * Created by Carsten Zimmermann on 08.11.2016.
 */

public class ValidationDialogFragment extends AppCompatDialogFragment
{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState)
    {
        ...
        dialogBuilder.setNeutralButton(buttonTextResourceId, new DialogInterface.OnClickListener()
        {
            @Override
